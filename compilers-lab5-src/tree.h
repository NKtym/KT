...
class Visitor {
    public:
        ...
        virtual void visit(loop_class &ref) {}
        virtual void visit(typcase_class &ref) {}
        ...
        virtual void visit(comp_class &ref) {}
        ...
        virtual void visit(isvoid_class &ref) {}
        virtual void visit(no_expr_class &ref) {}
